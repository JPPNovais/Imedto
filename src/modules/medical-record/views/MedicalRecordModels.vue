...
const secoesList = [
  { key: 'secao_queixa_principal', label: 'Queixa principal' },
  { key: 'secao_historia_atual', label: 'História atual' },
  { key: 'secao_historia_pregressa', label: 'História pregressa' },
  { key: 'secao_historia_familiar', label: 'História familiar' },
  { key: 'secao_historia_social', label: 'História social' },
  { key: 'secao_exame_fisico', label: 'Exame físico' },
  { key: 'secao_evolucao', label: 'Evolução' },
  { key: 'secao_exames_realizados', label: 'Exames realizados' },
  { key: 'secao_procedimentos_indicados', label: 'Procedimentos indicados' },
  { key: 'secao_evolucao_pre_operatoria', label: 'Evolução pré-operatória' },
  { key: 'secao_evolucao_pos_operatoria', label: 'Evolução pós-operatória' },
  { key: 'secao_detalhes_da_cirurgia', label: 'Informações da cirurgia' },
  { key: 'secao_descricao_cirurgica', label: 'Descrição cirúrgica' },
  { key: 'secao_equipe', label: 'Equipe' },
  { key: 'secao_fotos_do_paciente', label: 'Fotos do paciente' },
  { key: 'secao_anexos', label: 'Anexos' },
  { key: 'secao_conduta', label: 'Conduta' },
]
