-- Atualiza função criar_paciente_e_vincular para preencher estabelecimento_id
-- diretamente na tabela pacientes.
...
begin
  ...
  -- Mantém a tabela de vínculo, caso ainda seja usada em outras partes
